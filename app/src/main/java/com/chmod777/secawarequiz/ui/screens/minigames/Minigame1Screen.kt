...
fun Minigame1Screen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.minigame1_screen_title)) },
                navigationIcon = {
                    IconButton(onClick = { }) {
        ...
        Column(
            ...
            Text(stringResource(R.string.minigame1_placeholder_text), style = MaterialTheme.typography.bodyLarge)
        }
    }
}
